...
class DATAREAD():
    ...
    def initializedataset(self,Z,X,Y,X_baseline_encoded,Y_baseline_encoded,attributute,slected_features,unique_num=20 ):
        ...
        #data_train_discrete_selected_featured = data_train_discrete.drop(data_train_discrete.columns[slected_features],axis =1)
        #self.data_train_discrete_selected_featured =  data_train_discrete_selected_featured.to_numpy(dtype=np.float64)
        #print(self.data_train_discrete_selected_featured)
       ...
       #  print("___________________________________________")
         ...
         #print(self.data_train_discrete)

         #data_test_discrete_selected_featured = data_test_discrete.drop(data_test_discrete.columns[slected_features],axis =1)
         #self.data_test_discrete_selected_featured =  data_test_discrete_selected_featured.to_numpy(dtype=np.float64)
