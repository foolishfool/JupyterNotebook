...
class Experiment():
        ...
        def InitializedExperimentDataList(self,
            ...
            if compareType == 3: #discrete unnormalization
                 optimize_W.do_DOSOM(features_choosen,False)
                 #get self.discrete_data_embedding_sog  and  self.test_new_embedding_sog
                 #optimize_W.get_SOG_Embedding()
