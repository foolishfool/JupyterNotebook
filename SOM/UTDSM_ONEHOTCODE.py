...
class UTDSM_ONEHOTCODE():
    """
    The 2-D, rectangular grid self-organizing map class using Numpy.
    """
    def __init__(self, som,som_onehot, 
                            data_train_all, 
                            data_train_all_onehot,
                            data_test_all,
                            data_test_all_onehot,
                            label_train_all,                     
                            label_test_all,
                            row,column):
        """
        ...
        self.data_train_all_onehot = data_train_all_onehot
        self.data_test_all = data_test_all
        self.data_test_all_onehot = data_test_all_onehot
    ...
    def nmiScore(self,scorename, y_true, y_pred):
        ...
        if(scorename == "all_train_score_W0_onehot" ):
            self.all_train_score_W0_onehot_n = normalized_mutual_info_score(y_true,y_pred)
            print("all_train_score_W0_onehot_n {}".format(self.all_train_score_W0_onehot_n ))  
        if(scorename == "all_train_score_W_Combined" ):          
        ...
        if(scorename == "test_score_W0_onehot" ):
            self.test_score_W0_onehot_n = normalized_mutual_info_score(y_true,y_pred)
            print("test_score_W0_onehot_n {}".format(self.test_score_W0_onehot_n ))  
        if(scorename == "test_score_W_combined" ):
    ...
    def ariScore(self,scorename, y_true, y_pred):
       # print(" ariScore y_true{}  y_pred {} ".format(y_true,y_pred))
        ...
        if(scorename == "all_train_score_W0_onehot" ):
            self.all_train_score_W0_onehot_a = adjusted_rand_score(y_true,y_pred)
            print("all_train_score_W0_onehot_a {}".format(self.all_train_score_W0_onehot_a ))  
        if(scorename == "all_train_score_W_Combined" ):
        ...
        if(scorename == "test_score_W0_onehot" ):
            self.test_score_W0_onehot_a = adjusted_rand_score(y_true,y_pred)
            print("test_score_W0_onehot_a  {}".format(self.test_score_W0_onehot_a ))  
        if(scorename == "test_score_W_combined" ):
    ...
    def run(self):
       ...
       # self.som_onehot.fit(self.data_train_all_cleaned)
        self.som_onehot.fit_hamming_onehot(self.data_test_all_onehot)
        weight0 = self.som.weights0
        weight0_onehot = self.som_onehot.weights0
        self.train_W0_predicted_label = self.som.predict(self.data_train_all,weight0)   
        self.train_W0_predicted_label_onehot = self.som_onehot.predict_hamming(self.data_train_all_onehot,weight0_onehot)   
        ...
        predicted_clusters_onehot, current_clustered_datas_cleaned = self.get_indices_in_predicted_clusters(self.som_onehot.m*self.som_onehot.n, self.train_W0_predicted_label_onehot,self.data_train_all_onehot) 
        ...
        self.getLabelMapping( self.get_mapped_class_in_clusters(predicted_clusters_onehot) ,0)  
        # the value in predicted_clusters are true label value    
        transferred_predicted_label_train_W0_onehot =  self.convertPredictedLabelValue(self.train_W0_predicted_label_onehot,self.PLabel_to_Tlabel_Mapping_W0)      
        self.getScore("all_train_score_W0_onehot",self.train_label_all,transferred_predicted_label_train_W0_onehot)


        self.test_W0_predicted_label_onehot = self.som_onehot.predict_hamming(self.data_test_all_onehot,weight0_onehot)   
        transferred_predicted_label_test_W0_onehot = self.transferClusterLabelToClassLabel(False,weight0_onehot.shape[0],self.test_W0_predicted_label_onehot,self.data_test_all)    
        self.getScore("test_score_W0_onehot",self.test_label_all,transferred_predicted_label_test_W0_onehot)
