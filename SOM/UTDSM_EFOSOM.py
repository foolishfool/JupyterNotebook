...
class UTDSM_EFOSOM():
    ...
    """
    def __init__(self, som, soms,som_transferred,
                            data_train_all, 
    ...
    def run(self):
       ...
       # print("len(self.data_test_all_t {}".format(len(self.data_train_all_transferred)))
        for i in range(0,len(self.data_train_all_transferred)):
      ...
      # print("self.extracted_train_data shape 2 {}".format( np.array(self.extracted_train_data).shape))
        ...
        #print("extracted_train_data {}".format(self.extracted_train_data.shape))
