   ...
   # utility delete multiple obj in a list
    ...
    def run(self):
        ...
        *****************************************************************************************************************************************
        ...
        predicted_clusters_transferred, current_clustered_datas_cleaned = self.get_indices_and_data_in_predicted_clusters(weight0_total_discrete.shape[0], self.test_discrete_predicted_label_transferred,self.transferred_test_discrete_data) 

        self.getLabelMapping( self.get_mapped_class_in_clusters(predicted_clusters_transferred) ,2)  
        transferred_predicted_label_test_W_transferred =  self.convertPredictedLabelValue(self.test_discrete_predicted_label_transferred,self.PLabel_to_Tlabel_Mapping_W_Discrete)      
