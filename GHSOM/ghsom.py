...
class GHSOM(object):
    def __init__(self, xlsxnmae, filetype):
        if filetype == 0 :
...
# -----------------------------------input data random pre-process------------------------------------
        ...
        print("self.df_numerical {}".format(self.df_numerical))
        # -----------------------------------input data random pre-process------------------------------------
    ...
    def call_som(self,m, n, dim, input_data, weight_after_insertion=None, alpha=None, sigma=None):
        som = SOM(m, n, dim, weight_after_insertion)
        print("weight_after_insertion {}".format(weight_after_insertion))
    ...
    def check_tau2_condition (self,clustered_result_by_index, input_data, reault_mqe, mqe0, input_dim,m,mapname,level):
        ...
        print('---------------tau2*mqe0--------------')
        print(tau2*mqe0)
        print("reault_mqe {}".format(reault_mqe))
